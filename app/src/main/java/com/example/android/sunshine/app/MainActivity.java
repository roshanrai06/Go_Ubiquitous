...
public class MainActivity extends AppCompatActivity implements ForecastFragment.Callback, GoogleApiClient.ConnectionCallbacks,
    ...
    public void onConnected(Bundle bundle) {
        ...
        PutDataMapRequest putDataMapRequest = PutDataMapRequest.create("/sunshine/weatherUpdates");
        DataMap dataMap = putDataMapRequest.getDataMap();
        dataMap.putString("low", Utility.formatTemperature(getApplicationContext(), cursor.getDouble(DetailFragment.COL_WEATHER_MIN_TEMP)));
        dataMap.putString("high", Utility.formatTemperature(getApplicationContext(), cursor.getDouble(DetailFragment.COL_WEATHER_MAX_TEMP)));
        dataMap.putDouble("status", cursor.getDouble(DetailFragment.COL_WEATHER_CONDITION_ID));
    ...
    public void onConnectionSuspended(int i) {
        Log.d("Wearable", "Suspended");
    }

    @Override
    public void onConnectionFailed(ConnectionResult connectionResult) {
        Log.d("Wearable", "Failed");
    }
}